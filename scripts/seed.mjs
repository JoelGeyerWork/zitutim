 ...
 */
const ROSTER_SEED = [
  { key: "noa", directoryId: "8a1f0c2e-4d3b-4a91-9f70-1c2d3e4f5a01", displayName: "נועה ברקת", username: "noa.bareket" },
  { key: "itay", directoryId: "1c9d5b74-2e60-4f18-b3a2-7d51e0c48b12", displayName: "איתי שרון", username: "itay.sharon" },
  { key: "shira", directoryId: "b6740f31-8c25-4d0a-9e63-5a29d7fb1c33", displayName: "שירה לוי", username: "shira.levi" },
  { key: "daniel", directoryId: "3e82a5d0-77b9-4c46-8f11-6b0c94ae2d44", displayName: "דניאל עמר", username: "daniel.amar" },
  { key: "tamar", directoryId: "d05c3971-1a4e-4b82-97d5-2f6738ec9a55", displayName: "תמר רוזן", username: "tamar.rozen" },
  { key: "yonatan", directoryId: "77b1e2c8-9f30-4a57-8d24-3c81b05fa766", displayName: "יונתן כץ", username: "yonatan.katz" },
  { key: "maya", directoryId: "a4390d16-5b72-4e93-b108-9d47c2e6f877", displayName: "מאיה גלעד", username: "maya.gilad" },
  { key: "ori", directoryId: "62fd8b40-3c19-4a75-9b86-0e5721da3c88", displayName: "אורי בן־חיים", username: "ori.benhaim" },
];
...
try {
  ...
  if (process.argv.includes("--demo")) {
    ...
    if (existingThemes > 0) {
      ...
      // A `users` row per roster member, so the themes below reference a real
      // document. Keyed on directoryId and idempotent, exactly like a real login.
      const idByKey = {};
      const nameByKey = {};
